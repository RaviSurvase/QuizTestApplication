...
export default function SignUpForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const subject = "Welcome to QuizTest!!!";
            const body = `Dear ${fullName}\n,Welcome to QuizTest!!!\n Thank you for joining our community. 
                We are thrilled to have you with us. At QuizTest, we are committed to providing you with an exceptional experience and helping you succeed. We have a range of features and resources that we believe will enhance your journey.To get started, log in to your account and explore what we have to offer. If you have any questions or need assistance, our support team is always here to help.
